...
# args for network
parser.add_argument('--nGNNlayers', type=int,   default=3, help='No. of layers of feature extraction GNN including input layer')
parser.add_argument('--nMLPlayers', type=int,   default=2, help='No. of layers of MLP in fea extract GNN')
...
parser.add_argument('--nMLP_layers_actor',  type=int,   default=2, help='No. of layers in actor MLP')
parser.add_argument('--hidden_dim_actor',   type=int,   default=32, help='hidden dim of MLP in actor')
parser.add_argument('--nMLP_layers_critic', type=int,   default=2, help='No. of layers in critic MLP')
